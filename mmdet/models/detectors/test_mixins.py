...
from mmdet.core import (bbox2roi, bbox_mapping, merge_aug_bboxes, merge_aug_bboxes_variance,
                        merge_aug_masks, merge_aug_proposals, multiclass_nms, multiclass_soft_nms_variance_voting)
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        if len(aug_variance) == 0 or rcnn_test_cfg.nms.type != 'soft_nms_variance_voting':
            ...
            det_bboxes, det_labels = multiclass_soft_nms_variance_voting(merged_bboxes,
                     merged_variance, merged_scores, rcnn_test_cfg.score_thr, rcnn_test_cfg.nms,
                        rcnn_test_cfg.max_per_img, return_variance=return_variance)
        return det_bboxes, det_labels
