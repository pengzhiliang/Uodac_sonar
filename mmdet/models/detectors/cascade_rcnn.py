...
from mmdet.core import (bbox2result, bbox2roi, bbox_mapping, build_assigner,
                        build_sampler, merge_aug_bboxes, merge_aug_masks, merge_aug_bboxes_variance,
...
#         pdb.set_trace()
        ...
        for i in range(self.num_stages):
            ...
            bbox_targets = bbox_head.get_target(sampling_results, gt_bboxes,
                                                gt_labels, rcnn_train_cfg, img_meta)
    ...
    def simple_test(self, img, img_meta, proposals=None, rescale=False):
        ...
        det_bboxes, det_labels = self.bbox_head[-1].get_det_bboxes( # bbox_pred may be tuple
            rois,
            cls_score,
            bbox_pred,
            img_shape,
    ...
    def aug_test(self, imgs, img_metas, proposals=None, rescale=False):
        ...
        proposal_list = self.aug_test_rpn(
            base_feats, img_metas, self.test_cfg.rpn)
        ...
        if len(aug_variance) == 0 or rcnn_test_cfg.nms.type != 'soft_nms_variance_voting':
            ...
            det_bboxes, det_labels = multiclass_soft_nms_variance_voting(merged_bboxes, merged_variance,
                            merged_scores, rcnn_test_cfg.score_thr, rcnn_test_cfg.nms, rcnn_test_cfg.max_per_img,
                                                                        return_variance=return_variance)

        bbox_result = bbox2result(det_bboxes, det_labels,
                                  self.bbox_head[-1].num_classes, with_variance=return_variance)
